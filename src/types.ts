...
export interface Env {
  ...
  // Secret: EC P-256 private JWK used to sign the Agent Card. Generated by the
  // key holder with `node scripts/generate-card-key.mjs`, which pipes it straight
  // into `wrangler secret put` without printing it. Absent → card served unsigned.
