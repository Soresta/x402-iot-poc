...
1. **A** is closed on the code side. A1 and A2 were wrong and are withdrawn;
   ...
   A4 is active on the live card; one buying run with the key pinned is left.
