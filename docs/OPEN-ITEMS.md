...
1. **A** is closed on the code side. A1 and A2 were wrong and are withdrawn;
   ...
   A4 is built and tested and waits only for its key to be generated by the
