...
decision.
**Date:** 2026-09-08 · **updated for submission 2026-09-14**
...
| 4 | Human-dependent tests | 5 passed (stranger docs, 30-second demo, tutorial, `Ctrl+C`, explorer); 24 h run PARTIAL | a machine that stays awake for a day |
...
one exception: item 8 (rehearsals and the fallback video) is mine. It is in
`docs/OPEN-ITEMS.md` as B7 and B8, with what "done" looks like.
...
secrets in repo none — 312 history matches (270 distinct), all Base Sepolia
...
open            A: none · B: 2 open (rehearsal, video), 1 partial (24 h) · E: 5 blocked on decisions
```
