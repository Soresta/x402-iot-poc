...
- **Do not run other paid tests from the same wallet while it runs.** Concurrent
  payments from one wallet were observed failing at the facilitator on
  2026-09-11 (5 of 15 in a few minutes). Not proven to be the cause, but not
  worth confounding a 24-hour measurement with.
